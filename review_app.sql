...
VALUES
  (1, 'john.doe@example.com', 'johndoe', 'password123', 1, 0),
  (2, 'jane.smith@example.com', 'janesmith', 'securepass456', 1, 0),
...
VALUES 
  (1, 'Tasty Bites', 4, '123 Main Street', 5);
  (2, 'Crispy Crunch', 3, '456 Elm Street', 5);
  (3, 'Spice Palace', 5, '789 Oak Street', 2);
  (4, 'Fresh Delight', NULL, '101 Pine Street', 2);
  (5, 'Savory Eats', 4, '202 Maple Street', 5);
  (6, 'Sushi House', NULL, '304 Narra Street', 2);

-- Food Item
INSERT INTO `food_item` (`item_id`, `food_name`, `price`, `type`, `establishment_id`, `manager_id`) 
VALUES 
  (1, 'BOLOGNESE', 350, 'PASTA', 1, 5);
  (2, 'CHICKEN', 200, 'MEAT', 2, 5);
  (3, 'GARLIC SHRIMP', 250, 'FISH', 3, 2);
  (4, 'BUKO SHAKE', 180, 'BEVERAGE', 4, 2);
  (5, 'LEMON SQUARES', 120, 'DESSERT', 5, 5);
  (6, 'CHEESEBURGER', 140, 'MEAT', 3, 2);
  (7, 'CAESAR SALAD', 80, 'VEG', 3, 2);
...
INSERT INTO `food_review` VALUES
  ...
  (2, 5, "2024-03-10", 2, NULL, 3),
  (3, 1, "2024-05-09", 4, 4, 4),
  (4, 3, "2024-04-29", 5, 5, 4),
  (5, 2, "2024-05-01", 3, NULL, 1),
  (6, 2, "2024-05-09", 3, 7, 2),
  (7, 2, "2024-04-27", 3, 6, 5);